...
export default class App extends Component {
  pageSize=30;
  render() {
    document.body.style.backgroundColor="#F7EFE5";
    return (
      <div>
        <Router>
          <NavBar/>
          <Routes>
            <Route exact path="/" element={<News key='def' name="def" pageSize={this.pageSize} country='in' category='general'/>}></Route>
            <Route exact path="/home" element={<News key='home' name="home" pageSize={this.pageSize} country='in' category='general'/>}></Route>
